...
class Pagination extends React.Component {
    ...
    setPage(page) {
        var { items, itemsPerPage } = this.props;
        ...
        pager = this.getPager(items.length, page, itemsPerPage);
        ...
        return (
            <ul className="pagination">
                {/* <li className={pager.currentPage === 1 ? 'disabled' : ''}>
                    <a onClick={() => this.setPage(1)}>처음으로</a>
                </li> */}
                <li className={pager.currentPage === 1 ? 'disabled' : ''}>
                ...
                {/* <li className={pager.currentPage === pager.totalPages ? 'disabled' : ''}>
                    <a onClick={() => this.setPage(pager.totalPages)}>마지막</a>
                </li> */}
            </ul>
        );
    }
